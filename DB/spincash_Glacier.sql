...
--
-- Host: localhost:3306
-- Generation Time: May 12, 2019 at 09:02 PM
...
(3, 'Glacier', '66f4554054f7be6d27f2f9bc9b5916c2'),
(4, 'Mentor', 'b1403f60cc174a55e5f6d80bb2f7c64e'),
(6, 'admin2', 'adc5e79a002be7643e5fa0a60f112914'),
...
CREATE TABLE `transac` (
  ...
  `ph_date` varchar(300) NOT NULL,
  `gh_date` varchar(225) NOT NULL,
  `time` varchar(300) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `transac` (`ID`, `transacID`, `payer`, `recipient`, `amount`, `confirm`, `ph_date`, `gh_date`, `time`) VALUES
(2, 1, 'cliffordfavour', 'Ernest', 2000, 'pending', '2019-05-11', '2019-05-14', '15:58'),
(3, 2, 'clifford favour', 'Ernest', 2000, 'confirmed', '2019-05-11', '2019-05-14', '21:54');
...
--
ALTER TABLE `user_details`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT ' ', AUTO_INCREMENT=50;
COMMIT;
