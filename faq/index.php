                ...
                <div class="container">
                    <div class="page__header__content">
                        <div class="page__header__content__inner" id='navConverter'>
                            <h1 class="page__header__title">Frequently Asked Questions</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="app">
            <div class="container">
                <div class="text-container">
                    ...
                    <p><strong>Do I need to own a website to join?</strong><br>
                    No. As a registered member, you will get your own referral link. </p>You can use all marketing material that is being shared by other members and add your own ads/marketing material.</p>
    
                    <h2>The Program &amp; System</h2>
                    
                    <p><strong>How many people can I invite?</strong><br>
                    You can refer unlimited donators.</p>
                       
                    <p><strong>Can Free member earn any donation?</strong><br>
                    No. A member need to donate first before receiving donation. The receiver will approve your payment</p>
