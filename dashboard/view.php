          ...
          <div class="row-xl-3 row-md-6 mb-4">
              ...
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  ...
                  <div class="container" style="text-align:center;">
                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-3" style="font-size:15px;">Member ID (Not relevant): <?php echo $disid?></div>
                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-3" style="font-size:15px;">User Name: <?php echo $disun?></div>
                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-3" style="font-size:15px;">Member Email: <?php echo $disem?></div>
                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-3" style="font-size:15px;">Member Phone: <?php echo $disphone?></div>
                  </div>
                </div>
              </div>
              </div>
            ...
            <div class="card border-left-info border-bottom-info shadow h-100 py-2">
              <div class="card-body">
                <div class="row no-gutters align-items-center">
                  <div class="col mr-2">
                  Details Cannot be edited By Member At the Moment, Contact The Admin
                  </form>
                  </div>
                </div>
              </div>
